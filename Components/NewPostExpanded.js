...
import { faFlask, faImage, faImages, faMapMarkerAlt, faMarker, faSmile, faTimes, faUserPlus } from '@fortawesome/free-solid-svg-icons'
  ...
  return (
    <div className='newPostExpandedContainer'>
        ...
        <div className="post_entry">
            <textarea contentEditable={true} className='post_entry_field' placeholder="what's on your mind, Levi?"></textarea>
        </div>

        {/* THIS WILL SERVE AS AN AREA FOR ALL OTHER POST OPTIONS, THISS WILL CHANGE BASED ON WHAT STATE IS ACTIVE */}

        <div style={{display: addPostActive ? "block" : "none"}} className="addImageSection">
            <div className='addImageArea'>

                <label htmlFor="imageUpload">
                <div onClick={() => setaddPostActive(false)} className="imageCloseIcn">
                    <FontAwesomeIcon icon={faTimes} />
                </div>
        ...
        <div className="addPostOptions">
            ...
            <div className="postOptions">
                <div onClick={() => setaddPostActive(!addPostActive)} className="optionContainer addImage" title='Add Image'>
